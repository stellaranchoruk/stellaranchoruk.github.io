...
// Function to update an asset's stats, including dynamically fetched USD reserves.
function updateAssetStats(assetCode, assetIssuer, selectors, offerEndpoint, symbol, accountID, buybackAbility) {
  ...
  fetch(offerUrl)
    ...
    .then(offerData => {
      ...
      // Next, fetch the asset stats for circulating supply.
            ...
            return fetch(accountUrl)
              ...
              .then(accountData => {
                ...
                if (accountData && accountData.balances && Array.isArray(accountData.balances)) {
                  // Loop through the balances to find the USDC balance.
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  updateAssetStats(
    ...
    "£",
    "GDXF6SYWIQOKOZ7BACXHBFBLQZEIH25KOTTLWQK35GO3JKRNIFHHGBPC", // GBPC account
  ...
  updateAssetStats(
    ...
    "€",
    "GAP2JFYUBSSY65FIFUN3NTUKP6MQQ52QETQEBDM25PFMQE2EEN2EEURC", // EURC account
  ...
  updateAssetStats(
    ...
    "₩",
    "GA4JBPWVFUT2FETDSMSGBYDGH4FROYB5SYKLVQO7WGNZHCSB63OIKRWC", // KRWC account
